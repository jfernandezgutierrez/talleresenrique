    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <div class="hero-btns">
          ...
          >
          <a :href="'tel:' + s.phone_link" class="btn btn-outline"
            ><AppIcon name="phone" /> {{ s.phone }}</a
          >
        </div>
      ...
      <div class="container">
        ...
        <div style="text-align: center; margin-top: 2.5rem">
          <RouterLink to="/servicios" class="btn btn-secondary"
            >Ver todos los servicios →</RouterLink
          >
        </div>
      </div>
    </section>
...
const previewServices = [
  {
    ...
    desc: 'Reparación y mantenimiento de tractores, cosechadoras, segadoras, empacadoras y todo tipo de maquinaria de campo.',
  },
  {
    icon: 'cow',
    title: 'Maquinaria Ganadera',
    desc: 'Servicio técnico especializado en equipos de ordeño, refrigeración de leche y maquinaria para explotaciones ganaderas.',
  },
  {
    icon: 'tree',
    title: 'Maquinaria Forestal',
    desc: 'Reparación de motosierras, desbrozadoras, astilladoras, procesadoras y todo tipo de maquinaria forestal.',
  },
  {
    icon: 'leaf',
    title: 'Maquinaria de Jardín',
    desc: 'Venta y reparación de cortacéspedes, segadoras hileradoras Rapid, tractores de jardín y herramientas de jardinería.',
  },
  {
    icon: 'wrench',
    title: 'Taller de Reparación',
    desc: 'Diagnóstico y reparación de motores, sistemas hidráulicos, transmisiones, electricidad y soldadura.',
  },
  {
    icon: 'package',
