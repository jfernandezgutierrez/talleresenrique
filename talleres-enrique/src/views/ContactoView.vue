      ...
      <div class="container">
        <div class="contact-grid">
          ...
          <div class="contact-info">
            ...
            <p>
              Venta y reparación de maquinaria agrícola, ganadera, forestal, de jardín y ordeño en
              el Valle de Pas. Distribuidores oficiales Rapid para toda Cantabria.
            </p>
            ...
            <p class="pickup-note">
              <AppIcon name="truck" :size="15" /> {{ s.pickup_policy_text }}
            </p>
            ...
            <div class="info-cards">
              <div class="info-card" v-for="item in contactItems" :key="item.label">
                ...
                <div class="info-text">
                  <h4>{{ item.label }}</h4>
                  <component :is="item.href ? 'a' : 'p'" :href="item.href" :target="item.target">{{
                    item.value
                  }}</component>
                </div>
              </div>
              ...
              <div class="info-card">
                ...
                <div class="info-text">
                  ...
                  <div class="hours">
                    <div class="hours-row">
                      <span>Lunes – Viernes</span><strong>{{ s.hours_weekday }}</strong>
                    </div>
                    <div class="hours-row">
                      <span>Sábados</span><strong>{{ s.hours_saturday }}</strong>
                    </div>
                    <div class="hours-row">
                      <span>Domingos</span><strong>{{ s.hours_sunday }}</strong>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="form-card">
            ...
            <p>
              Toda consulta —presupuesto, avería, disponibilidad de una pieza— la gestionamos por
              WhatsApp. {{ s.response_time_text }}.
            </p>
            ...
            <ul class="wa-benefits">
              <li>
                <AppIcon name="check-circle" :size="14" /> Respuesta
                {{ s.response_time_text.replace('Te respondemos ', '') }}
              </li>
              <li>
                <AppIcon name="check-circle" :size="14" /> Envía fotos del problema o la pieza
                directamente
              </li>
...
const contactItems = computed(() => [
  { icon: 'map-pin', label: 'Dirección', value: s.value.address },
  {
    ...
    label: 'Teléfono / Fax',
    value: s.value.phone,
    href: 'tel:' + s.value.phone_link,
  },
  { icon: 'mail', label: 'Email', value: s.value.email, href: 'mailto:' + s.value.email },
  {
    icon: 'facebook',
    label: 'Facebook',
    value: 'Talleres Enrique en Facebook',
    href: s.value.facebook_url,
    target: '_blank',
  },
])
</script>
